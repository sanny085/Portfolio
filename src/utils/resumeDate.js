...
about: `I am Sanny Kumar completed my B-tech from Computer Science & Engineering Department at Dr. B.C. Roy Engineering College, Durgapur. I always Eager to learn and open to new challenges and also work on it. I am very passionate about Front-end Development, User-friendly product. But, also familiar with Back-end development. I am learning as well as working on this Skillset from last 3 and a half years. That's why this is fit for me. \n\nRecently, I have done project on Netflix-clone which was made using Hooks and States in React JS and for styling the entire project, I used plane CSS. This project imitates the fully Movie Web App Functionality. I created separate components (Screens) for Home, Login, Sign up, Banner. Implemented of TMDB API for different types of movie genres. Movie would be change depending on movie Api. To sign a user into this app uses Firebase Authentication to allow users to sign in to my app using one or more sign-in methods, including email address and password sign-in.`,
  ...
  education: [
    {
      ...
      description:
        "I spent the best 4 years at this college. It helped me to explore my potential. Where, I got ample time to dive into new domains and try new ventures",
      date: "2017 - 2021",
    },
    {
      title: "S.D College, Gauripur, Bhagalpur",
      description:
        " I've completed my Higher Secondary education in the Science stream.",
      date: "2014 - 2017",
    },
    {
